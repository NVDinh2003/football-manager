...
public class Constants {
    ...
    public static final String ALLREADY_MEMBER = "User is already a member of the team";
    public static final String ALLREADY_SEND_REQUEST = "You're already send request to this team";
